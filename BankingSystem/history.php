...
<section class="services py-5 bg-light" id="Services">
  <div  class="container">
    <div class="text-center my-2">
      <h1 data-aos="fade-up"data-aos-offset="200">Transaction<span class="text-primary">history
...
$sql="SELECT from_user,to_user,AMOUNT from history";
$result=$conn->query($sql);
 if ($result->num_rows>0){
   while($row=$result->fetch_assoc()){
     echo"<tr><td>".$row["from_user"]."</td><td>".$row["to_user"]."</td><td>".$row["AMOUNT"]."</td></tr>";
   }
   echo"</table>";
 }else{
   echo"0 result";
